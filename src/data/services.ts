...
export const SERVICE_PILLARS: ServicePillarInfo[] = [
  {
    ...
    description: "SaaS platforms, cloud applications, Next.js/React web apps, NestJS backends, and design systems.",
...
export const SERVICES: Service[] = [
  {
    ...
    description: "Custom SaaS product development from MVP to multi-tenant platform, with billing and cloud built in.",
    includes: ["Multi-tenant architecture", "Subscription billing (Stripe)", "SaaS product development process"],
    stat: "MVP from $24,000",
  },
  {
    pillar: "software-development",
    slug: "saas-web-design",
    title: "SaaS Website & UX Design",
    description: "A SaaS web design agency for brand identity, B2B websites, landing pages and product UX.",
    includes: ["Brand identity design", "B2B SaaS website design", "Product UX & design systems"],
    stat: "Brand, site & UX in one team",
  },
  {
    pillar: "software-development",
    slug: "cloud-application-development",
    title: "Cloud Application Development",
    description: "Cloud-native web apps, APIs and infrastructure on AWS, Google Cloud, Azure or Vercel.",
    includes: ["Cloud-based web development", "CI/CD & infrastructure as code", "Monitoring & cost controls"],
    stat: "Cloud-native, cost-aware",
  },
  {
    pillar: "software-development",
    slug: "nextjs-apps",
