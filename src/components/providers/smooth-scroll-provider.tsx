...
export function SmoothScrollProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const instance = new Lenis({
      ...
      wheelMultiplier: 1,
      touchMultiplier: 1.5,
      // Read the real document height on every scroll instead of a cached value.
      // The page grows after first paint (images, fonts, revealed sections), and a
      // stale height stops the scroll short of the bottom.
