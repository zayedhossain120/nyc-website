...
export const HOME_FAQ_PREVIEW = [
  {
    ...
    answer:
      "Yes. We are a SaaS development company that takes products from idea to launch: discovery, UX design, a multi-tenant build with subscription billing, and cloud deployment. Custom SaaS development starts at $24,000 on a fixed price.",
  },
  {
    question: "What does a SaaS web design agency do?",
    answer:
      "We design and build the website that sells your software: brand identity, homepage, product and pricing pages, landing pages and the demo or trial flow, plus the product interface itself so the brand feels consistent.",
  },
  {
