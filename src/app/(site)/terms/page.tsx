...
export const metadata: Metadata = {
  ...
  description: "The terms governing use of this site and engagements with NYC Digital Agency",
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      intro="These terms govern your use of this website and any services engagement with NYC Digital Agency By engaging us, you agree to the terms below alongside your signed statement of work."
      sections={[
        {
