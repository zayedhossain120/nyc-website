...
export const metadata: Metadata = {
  ...
  description:
    "Custom AI chatbots, automated lead & CRM workflows, and RAG/LLM integrations from NYC Digital Agency — the NYC agency that builds AI automation your team actually uses.",
