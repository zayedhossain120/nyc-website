...
export const metadata: Metadata = {
  ...
  description:
    "Answers to common questions about working with NYC Digital Agency, New York's software development and AI automation agency — service areas, pricing, IP ownership, AEO/GEO, and AI automation ROI.",
