...
export const metadata: Metadata = {
  title: "Careers | Join NYC Digital Agency in New York City",
  description: "Careers at NYC Digital Agency — a senior-only, NYC engineering-first software development and AI automation agency.",
  ...
  return (
    <main className="flex flex-1 flex-col">
      ...
      <section className="mx-auto flex w-full max-w-7xl flex-col gap-10 px-6 py-24 md:px-16">
        <SectionHeading eyebrow="Why NYC Digital Agency" title="What it's actually like here." />
      ...
      <section className="border-t border-subtle">
        <Reveal className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-6 py-24 md:px-16">
          ...
          <Button href="mailto:careers@nycdigital.agency" variant="primary" className="w-fit">
            Introduce Yourself
          </Button>
        </Reveal>
      </section>
