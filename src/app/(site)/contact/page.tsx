...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with NYC Digital Agency — tell us what you're building and get a response within one business day. Based in the Financial District, Manhattan.",
  ...
  return (
    <main className="flex flex-1 flex-col">
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-16 px-6 py-20 md:px-16 md:py-28 lg:grid-cols-2 lg:items-start">
        <TrustPanel />
        <Reveal className="rounded-2xl border border-subtle bg-surface/60 p-6 backdrop-blur-sm sm:p-8">
          <ContactForm />
        </Reveal>
      </section>
    </main>
