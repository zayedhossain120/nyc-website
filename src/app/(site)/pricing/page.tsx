...
import { ADD_ONS, PRICING_TIERS } from "@/data/pricing";
...
export const metadata: Metadata = {
  ...
  description:
    "Fixed-price engagement tiers from NYC Digital Agency, New York's software development and AI automation agency — no hourly billing, full IP ownership, transparent add-on pricing.",
  ...
  return (
    <main className="flex flex-1 flex-col">
      <JsonLd
        data={[
          offerCatalogSchema({
            name: "NYC Digital Agency Engagement Tiers",
