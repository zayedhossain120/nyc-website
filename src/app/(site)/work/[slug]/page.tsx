...
import { CASE_STUDIES, CATEGORY_LABELS, CATEGORY_TONE, getCaseStudyBySlug } from "@/data/case-studies";
...
export async function generateMetadata(props: PageProps<"/work/[slug]">): Promise<Metadata> {
  ...
  return {
    ...
    description: `${study.summary} A NYC Digital Agency design case study.`,
