...
export const metadata: Metadata = {
  ...
  description: "How NYC Digital Agency collects, uses, and protects your data.",
...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      intro="This policy explains what information NYC Digital Agency collects when you use this site or engage us for services, and how we use it."
      sections={[
        {
        ...
        },
        {
          ...
          body: [
            "You may request access to, correction of, or deletion of your personal data at any time by contacting privacy@nycdigital.agency. We respond to verified requests within 30 days.",
          ],
        },
        {
          heading: "7. Contact Us",
          body: [
            "Questions about this policy can be directed to privacy@nycdigital.agency or our NYC office at 45 Broad Street, Floor 12, New York, NY 10004.",
          ],
        },
      ]}
    />
