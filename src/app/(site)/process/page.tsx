...
export const metadata: Metadata = {
  ...
  description:
    "NYC Digital Agency's 21-day engagement methodology, from discovery to launch — the same four-phase process behind every NYC software, AI automation, and growth engagement.",
  ...
  return (
    <main className="flex flex-1 flex-col">
      <JsonLd
        data={[
          howToSchema({
            name: "How NYC Digital Agency Builds Software and AI Automation Systems",
            description: "The four-phase, 21-day engagement methodology NYC Digital Agency follows on every project.",
