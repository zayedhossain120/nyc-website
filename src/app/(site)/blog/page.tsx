...
export const metadata: Metadata = {
  ...
  description:
    "Notes on building, marketing, and automating — full-stack engineering, NYC SEO/GEO, and AI automation insights from the NYC Digital Agency team.",
  alternates: { canonical: "/blog" },
  openGraph: {
    title: "Blog | NYC Digital Agency",
    description:
      "Full-stack engineering, NYC SEO/GEO, and AI automation insights from the NYC Digital Agency team.",
    type: "website",
  },
};
